...
help: ## Show this help message
	...
	@echo "♻  build : crea los contenedores" ##TODO el resto de echos
	@echo "♻✨ migrate file=Version : migrates to a specific version (use just the filename)"
	@echo "♻  migration_list : shows the list of migrations"
	@echo "♻  migration_generate : create a new migration file"
